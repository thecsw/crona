...
class TypeAnalysis {
	...
	{
		hasError = true;
		Report::fatal(line, col, "Attempt to output a function");
	}
	void errWriteVoid(size_t line, size_t col)
	{
		hasError = true;
		Report::fatal(line, col, "Attempt to output void");
	}
	void errWriteArray(size_t line, size_t col)
	{
		hasError = true;
		Report::fatal(line, col, "Attempt to output array");
	}
	void errReadFn(size_t line, size_t col)
	{
		hasError = true;
		Report::fatal(line, col, "Attempt to read a function");
	}
	...
	{
		hasError = true;
		Report::fatal(line, col, "Missing return value");
	}
	void errRetValueFromVoid(size_t line, size_t col)
	{
		hasError = true;
		Report::fatal(line, col,
	...
	{
		hasError = true;
		Report::fatal(line, col, "Bad return value");
	}
	...
	{
		hasError = true;
		Report::fatal(line, col, "Invalid equality operand");
	}
	void errEqOpr(size_t line, size_t col)
	{
		hasError = true;
		Report::fatal(line, col, "Invalid equality operation");
	}
	void errAssignOpd(size_t line, size_t col)
	{
		hasError = true;
		Report::fatal(line, col, "Invalid assignment operand");
	}
	void errAssignOpr(size_t line, size_t col)
	{
		hasError = true;
		Report::fatal(line, col, "Invalid assignment operation");
	}
