...
enum BaseType { INT, VOID, BOOL, BYTE };
...
class DataType {
	...
	virtual const FnType *asFn() const
	{
		return nullptr;
	}
	virtual const ErrorType *asError() const
	{
		return nullptr;
	}
...
class ErrorType : public DataType {
	...
	virtual const ErrorType *asError() const override
	{
		return this;
	}
...
class BasicType : public DataType {
    ...
    private:
	BasicType(BaseType base) : myBaseType(base)
	{
	}
	BaseType myBaseType;
};
...
class ArrayType : public DataType {
	...
	const ArrayType *asArray() const override
	{
		return this;
	}
	int getLength() const
...
class FnType : public DataType {
    public:
	FnType(const std::list<const DataType *> *formalsIn,
	       const DataType *retTypeIn)
		: DataType(), myFormalTypes(formalsIn), myRetType(retTypeIn)
	{
	}
	std::string getString() const override
	{
	...
	virtual const FnType *asFn() const override
	{
		return this;
	}
